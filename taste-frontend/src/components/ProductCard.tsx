...
const ProductCard = ({
	...
	return (
		<div className="flex py-3 px-6 relative select-none lg:cursor-pointer rounded-md bg-gray-50 border-slate-100 border-2 shadow-md shadow-gray-100 flex-col justify-center items-center dark:bg-neutral-800 dark:shadow-zinc-800 dark:border-neutral-800">
			...
			<div className="dark:text-gray-50">
				...
				<div className=" font-light">
					{parseFloat(domestic_price).toFixed(2)} {domestic_price_currency}
				</div>
			</div>
			<div className="mt-3">
